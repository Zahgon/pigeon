...
var g = &grammar{
	rules: []*rule{
		{
			name: "Test",
			pos:  position{line: 6, col: 1, offset: 70},
			expr: &actionExpr{
				pos: position{line: 6, col: 9, offset: 78},
				run: (*parser).callonTest1,
				expr: &anyMatcher{
					line: 6, col: 9, offset: 78,
				},
			},
		},
	},
...
func (c *current) onTest1() (any, error) { _ = "STUB: not implemented"; return *new(any), nil }

func (p *parser) callonTest1() (any, error) { _ = "STUB: not implemented"; return *new(any), nil }
