...
var g = &grammar{
	rules: []*rule{
		{
			name: "start",
			pos:  position{line: 5, col: 1, offset: 34},
			expr: &actionExpr{
				pos: position{line: 5, col: 9, offset: 42},
				...
				expr: &seqExpr{
					...
					exprs: []any{
						...
						&zeroOrOneExpr{
							pos: position{line: 10, col: 3, offset: 128},
							expr: &labeledExpr{
								pos:   position{line: 10, col: 4, offset: 129},
								label: "a",
								expr: &ruleRefExpr{
									pos:  position{line: 10, col: 6, offset: 131},
									name: "expr",
								},
							},
						},
		...
		{
			name: "expr",
			pos:  position{line: 14, col: 1, offset: 173},
			expr: &choiceExpr{
				pos: position{line: 14, col: 9, offset: 181},
				alternatives: []any{
					&seqExpr{
						pos: position{line: 14, col: 9, offset: 181},
						exprs: []any{
							&seqExpr{
								pos: position{line: 14, col: 10, offset: 182},
								exprs: []any{
									&ruleRefExpr{
										pos:  position{line: 14, col: 10, offset: 182},
										name: "expr",
									...
									&choiceExpr{
										pos: position{line: 14, col: 16, offset: 188},
										alternatives: []any{
											&litMatcher{
												pos:        position{line: 14, col: 16, offset: 188},
												val:        "+",
											...
											&litMatcher{
												pos:        position{line: 14, col: 22, offset: 194},
												val:        "-",
												ignoreCase: false,
												want:       "\"-\"",
											},
									...
									&ruleRefExpr{
										pos:  position{line: 14, col: 27, offset: 199},
										name: "term",
									},
								},
							},
							&stateCodeExpr{
								pos: position{line: 14, col: 33, offset: 205},
								run: (*parser).callonexpr9,
							},
						},
					},
					&seqExpr{
		...
		{
			name: "term",
			pos:  position{line: 22, col: 1, offset: 355},
			expr: &choiceExpr{
				pos: position{line: 22, col: 8, offset: 362},
				alternatives: []any{
					&seqExpr{
						pos: position{line: 22, col: 8, offset: 362},
						exprs: []any{
							&seqExpr{
								...
								exprs: []any{
									...
									&choiceExpr{
										pos: position{line: 22, col: 15, offset: 369},
										alternatives: []any{
											&litMatcher{
												pos:        position{line: 22, col: 15, offset: 369},
												val:        "*",
											...
											&litMatcher{
												pos:        position{line: 22, col: 21, offset: 375},
												val:        "/",
												ignoreCase: false,
												want:       "\"/\"",
											},
											&litMatcher{
												pos:        position{line: 22, col: 27, offset: 381},
												val:        "%",
												ignoreCase: false,
												want:       "\"%\"",
											},
									...
									&ruleRefExpr{
										pos:  position{line: 22, col: 32, offset: 386},
										name: "factor",
									},
								},
							},
							&stateCodeExpr{
								pos: position{line: 22, col: 40, offset: 394},
								run: (*parser).callonterm10,
							},
						},
					},
					&seqExpr{
						pos: position{line: 25, col: 5, offset: 467},
						exprs: []any{
							&ruleRefExpr{
								pos:  position{line: 25, col: 5, offset: 467},
								name: "factor",
							...
							&stateCodeExpr{
								pos: position{line: 25, col: 12, offset: 474},
		...
		{
			name: "factor",
			pos:  position{line: 30, col: 1, offset: 547},
			expr: &choiceExpr{
				pos: position{line: 30, col: 10, offset: 556},
				alternatives: []any{
					&seqExpr{
						pos: position{line: 30, col: 10, offset: 556},
						exprs: []any{
							&seqExpr{
								pos: position{line: 30, col: 11, offset: 557},
								exprs: []any{
									&choiceExpr{
										pos: position{line: 30, col: 12, offset: 558},
										alternatives: []any{
											&litMatcher{
												pos:        position{line: 30, col: 12, offset: 558},
												val:        "+",
											...
											&litMatcher{
												pos:        position{line: 30, col: 18, offset: 564},
												val:        "-",
												ignoreCase: false,
												want:       "\"-\"",
											},
									...
									&ruleRefExpr{
										pos:  position{line: 30, col: 23, offset: 569},
										name: "factor",
									},
								},
							},
							&stateCodeExpr{
								pos: position{line: 30, col: 31, offset: 577},
								run: (*parser).callonfactor8,
							},
						},
					},
					&seqExpr{
						pos: position{line: 33, col: 5, offset: 651},
						exprs: []any{
							&ruleRefExpr{
								pos:  position{line: 33, col: 5, offset: 651},
								name: "atom",
							...
							&stateCodeExpr{
								pos: position{line: 33, col: 10, offset: 656},
		...
		{
			name: "atom",
			pos:  position{line: 38, col: 1, offset: 729},
			expr: &seqExpr{
				pos: position{line: 38, col: 8, offset: 736},
				exprs: []any{
					&oneOrMoreExpr{
						pos: position{line: 38, col: 9, offset: 737},
					...
					&stateCodeExpr{
						pos: position{line: 38, col: 17, offset: 745},
...
func (c *current) onstart3() error { _ = "STUB: not implemented"; return nil }

func (p *parser) callonstart3() error { _ = "STUB: not implemented"; return nil }

func (c *current) onstart1() (any, error) { _ = "STUB: not implemented"; return *new(any), nil }

func (p *parser) callonstart1() (any, error) { _ = "STUB: not implemented"; return *new(any), nil }

func (c *current) onexpr9() error { _ = "STUB: not implemented"; return nil }

func (p *parser) callonexpr9() error { _ = "STUB: not implemented"; return nil }

func (c *current) onexpr12() error { _ = "STUB: not implemented"; return nil }

func (p *parser) callonexpr12() error { _ = "STUB: not implemented"; return nil }

func (c *current) onterm10() error { _ = "STUB: not implemented"; return nil }

func (p *parser) callonterm10() error { _ = "STUB: not implemented"; return nil }

func (c *current) onterm13() error { _ = "STUB: not implemented"; return nil }

func (p *parser) callonterm13() error { _ = "STUB: not implemented"; return nil }

func (c *current) onfactor8() error { _ = "STUB: not implemented"; return nil }

func (p *parser) callonfactor8() error { _ = "STUB: not implemented"; return nil }

func (c *current) onfactor11() error { _ = "STUB: not implemented"; return nil }

func (p *parser) callonfactor11() error { _ = "STUB: not implemented"; return nil }

func (c *current) onatom4() error { _ = "STUB: not implemented"; return nil }

func (p *parser) callonatom4() error { _ = "STUB: not implemented"; return nil }
