...
func ids(id, list any) (any, error) { _ = "STUB: not implemented"; return *new(any), nil }
...
var g = &grammar{
	rules: []*rule{
			...
			expr: &recoveryExpr{
				...
				expr: &recoveryExpr{
						...
						expr: &seqExpr{
							...
							exprs: []any{
								&labeledExpr{
									...
									label: "id",
									expr: &ruleRefExpr{
										pos:  position{line: 18, col: 8, offset: 253},
										name: "ID",
									},
								},
								&labeledExpr{
									pos:   position{line: 18, col: 11, offset: 256},
									label: "list",
									expr: &ruleRefExpr{
										pos:  position{line: 18, col: 16, offset: 261},
										name: "List",
									},
								},
							},
					...
					recoverExpr: &ruleRefExpr{
						pos:  position{line: 20, col: 16, offset: 308},
						name: "ErrComma",
					},
					failureLabel: []string{
						"errComma",
				...
				recoverExpr: &ruleRefExpr{
					pos:  position{line: 20, col: 35, offset: 327},
					name: "ErrID",
				},
				failureLabel: []string{
					"errId",
		...
		{
			name: "List",
			pos:  position{line: 21, col: 1, offset: 333},
			expr: &choiceExpr{
				...
				alternatives: []any{
					&notExpr{
						pos: position{line: 21, col: 8, offset: 342},
						expr: &anyMatcher{
							line: 21, col: 9, offset: 343,
						},
					},
					&actionExpr{
						pos: position{line: 21, col: 13, offset: 347},
						...
						expr: &seqExpr{
							...
							exprs: []any{
								...
								&labeledExpr{
									pos:   position{line: 21, col: 19, offset: 353},
									label: "id",
									expr: &ruleRefExpr{
								...
								&labeledExpr{
									pos:   position{line: 21, col: 25, offset: 359},
									label: "list",
									expr: &ruleRefExpr{
										pos:  position{line: 21, col: 30, offset: 364},
										name: "List",
									},
								},
							},
		...
		},
		{
			...
			expr: &choiceExpr{
				pos: position{line: 24, col: 6, offset: 405},
				alternatives: []any{
					&actionExpr{
						pos: position{line: 24, col: 6, offset: 405},
						...
						expr: &seqExpr{
							...
							exprs: []any{
								...
								&oneOrMoreExpr{
									pos: position{line: 24, col: 9, offset: 408},
					...
					&throwExpr{
						pos:   position{line: 26, col: 5, offset: 481},
						label: "errId",
					},
				},
			},
		...
		{
			name: "Comma",
			pos:  position{line: 27, col: 1, offset: 490},
			expr: &choiceExpr{
				pos: position{line: 27, col: 9, offset: 500},
				alternatives: []any{
					&seqExpr{
						pos: position{line: 27, col: 9, offset: 500},
						exprs: []any{
							...
							&litMatcher{
								pos:        position{line: 27, col: 12, offset: 503},
								val:        ",",
								ignoreCase: false,
								want:       "\",\"",
							},
		...
		},
		{
			...
			expr: &zeroOrMoreExpr{
				pos: position{line: 28, col: 6, offset: 528},
				expr: &charClassMatcher{
					pos:        position{line: 28, col: 6, offset: 528},
					val:        "[ \\t\\r\\n]",
					chars:      []rune{' ', '\t', '\r', '\n'},
		...
		{
			name: "ErrComma",
			pos:  position{line: 30, col: 1, offset: 540},
			expr: &seqExpr{
				pos: position{line: 30, col: 12, offset: 553},
				exprs: []any{
					&stateCodeExpr{
						pos: position{line: 30, col: 12, offset: 553},
					...
					&zeroOrMoreExpr{
						pos: position{line: 32, col: 7, offset: 605},
						expr: &seqExpr{
							pos: position{line: 32, col: 9, offset: 607},
							exprs: []any{
								&notExpr{
									pos: position{line: 32, col: 9, offset: 607},
									expr: &oneOrMoreExpr{
										pos: position{line: 32, col: 11, offset: 609},
										expr: &charClassMatcher{
											pos:        position{line: 32, col: 11, offset: 609},
											val:        "[a-z]",
											ranges:     []rune{'a', 'z'},
		...
		},
		{
			...
			expr: &actionExpr{
				pos: position{line: 33, col: 9, offset: 631},
				...
				expr: &seqExpr{
					...
					exprs: []any{
						...
						&zeroOrMoreExpr{
							pos: position{line: 35, col: 7, offset: 693},
							expr: &seqExpr{
								pos: position{line: 35, col: 9, offset: 695},
								exprs: []any{
									&notExpr{
										pos: position{line: 35, col: 9, offset: 695},
										expr: &litMatcher{
											pos:        position{line: 35, col: 11, offset: 697},
											val:        ",",
											ignoreCase: false,
											want:       "\",\"",
										},
...
func (c *current) onS3(id, list any) (any, error) { _ = "STUB: not implemented"; return *new(any), nil }

func (p *parser) callonS3() (any, error) { _ = "STUB: not implemented"; return *new(any), nil }

func (c *current) onList4(id, list any) (any, error) {
	_ = "STUB: not implemented"
	return *new(any), nil
}

func (p *parser) callonList4() (any, error) { _ = "STUB: not implemented"; return *new(any), nil }
