...
var g = &grammar{
	rules: []*rule{
		{
			name: "start",
			pos:  position{line: 5, col: 1, offset: 29},
			expr: &actionExpr{
				pos: position{line: 5, col: 9, offset: 37},
				...
				expr: &seqExpr{
					...
					exprs: []any{
						&labeledExpr{
							...
							label: "a",
							expr: &ruleRefExpr{
								pos:  position{line: 5, col: 11, offset: 39},
								name: "expr",
							},
						},
						&notExpr{
							pos: position{line: 5, col: 16, offset: 44},
							expr: &anyMatcher{
								line: 5, col: 17, offset: 45,
							},
						},
					},
				},
		...
		},
		{
			...
			expr: &choiceExpr{
				...
				alternatives: []any{
						...
						expr: &seqExpr{
							...
							exprs: []any{
								...
								&labeledExpr{
									...
									expr: &choiceExpr{
										...
										alternatives: []any{
											...
											&litMatcher{
												pos:        position{line: 9, col: 26, offset: 92},
												val:        "-",
												ignoreCase: false,
												want:       "\"-\"",
											},
								...
								&labeledExpr{
									...
									label: "b",
									expr: &ruleRefExpr{
										pos:  position{line: 9, col: 33, offset: 99},
										name: "term",
									},
								},
							},
					...
					&actionExpr{
						pos: position{line: 14, col: 5, offset: 237},
						run: (*parser).callonexpr12,
						expr: &labeledExpr{
							pos:   position{line: 14, col: 5, offset: 237},
							label: "a",
							expr: &ruleRefExpr{
								pos:  position{line: 14, col: 7, offset: 239},
								name: "term",
							},
						},
					},
		...
		{
			name: "term",
			pos:  position{line: 19, col: 1, offset: 293},
			expr: &choiceExpr{
				pos: position{line: 19, col: 8, offset: 300},
				alternatives: []any{
					&actionExpr{
						pos: position{line: 19, col: 8, offset: 300},
						...
						expr: &seqExpr{
							...
							exprs: []any{
								&labeledExpr{
									...
									label: "a",
									expr: &ruleRefExpr{
										pos:  position{line: 19, col: 10, offset: 302},
										name: "term",
									},
								},
								&labeledExpr{
									pos:   position{line: 19, col: 15, offset: 307},
									label: "op",
									expr: &choiceExpr{
										pos: position{line: 19, col: 19, offset: 311},
										alternatives: []any{
											&litMatcher{
												pos:        position{line: 19, col: 19, offset: 311},
												val:        "*",
											...
											&litMatcher{
												pos:        position{line: 19, col: 25, offset: 317},
												val:        "/",
												ignoreCase: false,
												want:       "\"/\"",
											},
											&litMatcher{
												pos:        position{line: 19, col: 31, offset: 323},
												val:        "%",
												ignoreCase: false,
												want:       "\"%\"",
											},
								...
								&labeledExpr{
									pos:   position{line: 19, col: 36, offset: 328},
									label: "b",
									expr: &ruleRefExpr{
										pos:  position{line: 19, col: 38, offset: 330},
										name: "factor",
									},
								},
							},
					...
					&actionExpr{
						pos: position{line: 25, col: 5, offset: 472},
						run: (*parser).callonterm13,
						expr: &labeledExpr{
							pos:   position{line: 25, col: 5, offset: 472},
							label: "a",
							expr: &ruleRefExpr{
								pos:  position{line: 25, col: 7, offset: 474},
								name: "factor",
							},
						},
					},
		...
		{
			name: "factor",
			pos:  position{line: 30, col: 1, offset: 530},
			expr: &choiceExpr{
				pos: position{line: 30, col: 10, offset: 539},
				alternatives: []any{
					&actionExpr{
						pos: position{line: 30, col: 10, offset: 539},
						...
						expr: &seqExpr{
							...
							exprs: []any{
								&labeledExpr{
									...
									label: "op",
									expr: &choiceExpr{
										pos: position{line: 30, col: 14, offset: 543},
										alternatives: []any{
											&litMatcher{
												pos:        position{line: 30, col: 14, offset: 543},
												val:        "+",
											...
											&litMatcher{
												pos:        position{line: 30, col: 20, offset: 549},
												val:        "-",
												ignoreCase: false,
												want:       "\"-\"",
											},
								...
								&labeledExpr{
									pos:   position{line: 30, col: 25, offset: 554},
									label: "a",
									expr: &ruleRefExpr{
										pos:  position{line: 30, col: 27, offset: 556},
										name: "factor",
									},
								},
							},
					...
					&actionExpr{
						pos: position{line: 34, col: 5, offset: 666},
		...
		{
			name: "atom",
			pos:  position{line: 38, col: 1, offset: 707},
			expr: &oneOrMoreExpr{
...
func (c *current) onstart1(a any) (any, error) { _ = "STUB: not implemented"; return *new(any), nil }
...
func (p *parser) callonexpr2() (any, error) { _ = "STUB: not implemented"; return *new(any), nil }

func (c *current) onexpr12(a any) (any, error) { _ = "STUB: not implemented"; return *new(any), nil }

func (p *parser) callonexpr12() (any, error) { _ = "STUB: not implemented"; return *new(any), nil }
...
func (p *parser) callonterm2() (any, error) { _ = "STUB: not implemented"; return *new(any), nil }

func (c *current) onterm13(a any) (any, error) { _ = "STUB: not implemented"; return *new(any), nil }

func (p *parser) callonterm13() (any, error) { _ = "STUB: not implemented"; return *new(any), nil }
...
func (c *current) onfactor10() (any, error) { _ = "STUB: not implemented"; return *new(any), nil }

func (p *parser) callonfactor10() (any, error) { _ = "STUB: not implemented"; return *new(any), nil }
