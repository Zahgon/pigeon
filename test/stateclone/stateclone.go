...
func (vals values) Clone() any { _ = "STUB: not implemented"; return *new(any) }
	...
	rules: []*rule{
		{
			...
			expr: &actionExpr{
				pos: position{line: 14, col: 9, offset: 171},
				...
				expr: &seqExpr{
					...
					exprs: []any{
						...
						&zeroOrMoreExpr{
							pos: position{line: 21, col: 3, offset: 296},
							expr: &seqExpr{
								pos: position{line: 21, col: 4, offset: 297},
								exprs: []any{
									&choiceExpr{
										pos: position{line: 21, col: 5, offset: 298},
										alternatives: []any{
											&ruleRefExpr{
												pos:  position{line: 21, col: 5, offset: 298},
												name: "x",
											...
											&ruleRefExpr{
												pos:  position{line: 21, col: 7, offset: 300},
												name: "y",
											},
											&ruleRefExpr{
												pos:  position{line: 21, col: 9, offset: 302},
												name: "z",
											},
										},
									},
									&zeroOrMoreExpr{
										pos: position{line: 21, col: 12, offset: 305},
										expr: &ruleRefExpr{
											pos:  position{line: 21, col: 12, offset: 305},
											name: "ws",
										},
		...
		{
			name: "x",
			pos:  position{line: 25, col: 1, offset: 347},
			expr: &seqExpr{
				pos: position{line: 25, col: 5, offset: 351},
				exprs: []any{
					&litMatcher{
						pos:        position{line: 25, col: 5, offset: 351},
						val:        "ab",
					...
					&ruleRefExpr{
						pos:  position{line: 25, col: 10, offset: 356},
						name: "c",
					},
					&litMatcher{
						pos:        position{line: 25, col: 12, offset: 358},
						val:        "d",
						ignoreCase: false,
						want:       "\"d\"",
					},
		...
		{
			name: "y",
			pos:  position{line: 26, col: 1, offset: 362},
			expr: &seqExpr{
				pos: position{line: 26, col: 5, offset: 366},
				exprs: []any{
					&litMatcher{
						pos:        position{line: 26, col: 5, offset: 366},
						val:        "a",
					...
					&ruleRefExpr{
						pos:  position{line: 26, col: 9, offset: 370},
						name: "bc",
					},
					&litMatcher{
						pos:        position{line: 26, col: 12, offset: 373},
						val:        "e",
						ignoreCase: false,
						want:       "\"e\"",
					},
		...
		{
			name: "z",
			pos:  position{line: 27, col: 1, offset: 377},
			expr: &seqExpr{
				pos: position{line: 27, col: 5, offset: 381},
				exprs: []any{
					&litMatcher{
						pos:        position{line: 27, col: 5, offset: 381},
						val:        "abcf",
					...
					&stateCodeExpr{
						pos: position{line: 27, col: 12, offset: 388},
						run: (*parser).callonz3,
					},
				},
			},
		...
		{
			name: "c",
			pos:  position{line: 29, col: 1, offset: 459},
			expr: &seqExpr{
				pos: position{line: 29, col: 5, offset: 463},
				exprs: []any{
					&litMatcher{
						pos:        position{line: 29, col: 5, offset: 463},
						val:        "c",
					...
					&stateCodeExpr{
						pos: position{line: 29, col: 9, offset: 467},
						run: (*parser).callonc3,
					},
				},
			},
		},
		{
			...
			expr: &seqExpr{
				pos: position{line: 30, col: 6, offset: 543},
				exprs: []any{
					&litMatcher{
						pos:        position{line: 30, col: 6, offset: 543},
						val:        "bc",
					...
					&stateCodeExpr{
						pos: position{line: 30, col: 11, offset: 548},
		...
		{
			name: "ws",
			pos:  position{line: 32, col: 1, offset: 619},
			expr: &choiceExpr{
				pos: position{line: 32, col: 6, offset: 624},
				alternatives: []any{
					&litMatcher{
						pos:        position{line: 32, col: 6, offset: 624},
						val:        " ",
					...
					&litMatcher{
						pos:        position{line: 32, col: 12, offset: 630},
						val:        "\n",
						ignoreCase: false,
						want:       "\"\\n\"",
					},
...
func (c *current) onz3() error { _ = "STUB: not implemented"; return nil }

func (p *parser) callonz3() error { _ = "STUB: not implemented"; return nil }

func (c *current) onc3() error { _ = "STUB: not implemented"; return nil }

func (p *parser) callonc3() error { _ = "STUB: not implemented"; return nil }

func (c *current) onbc3() error { _ = "STUB: not implemented"; return nil }

func (p *parser) callonbc3() error { _ = "STUB: not implemented"; return nil }
